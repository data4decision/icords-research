...
const OrganisationDatabase = () => {
  ...
  topics: {
    policy: [
      "National data architecture strategy and design patterns",
      "Distributed databases for cross-ministry data integration",
      "Polyglot persistence for mixed government data types",
      "National data lake and statistical warehouse architecture",
      "ETL/ELT pipelines for government data aggregation",
      "Governance-aligned data modelling for public sector",
      "Cloud database platforms for national information systems (AWS GovCloud, Azure)",
      "Database security and access control at national scale",
      "Metadata management for open government data catalogues",
      "Applied research data architecture for policy analysis"
    ],
    business: [
      "Enterprise data architecture strategy and patterns",
      "Distributed databases for multi-region business operations",
      "Polyglot persistence for diverse commercial data types",
      "Enterprise data lake and analytics warehouse design",
      "ETL/ELT pipeline design for BI and reporting platforms",
      "Governance-aligned data modelling for regulated industries",
      "Cloud database platforms (AWS RDS, Azure SQL, GCP)",
      "Database security and access control for enterprise scale",
      "Metadata management and enterprise data cataloguing",
      "Applied research data architecture for business intelligence"
    ],
    livelihood: [
      "Federated data architecture for multi-partner programmes",
      "Distributed databases for regional development data systems",
      "Polyglot persistence for mixed livelihoods data types",
      "Programme data lake and impact warehouse architecture",
      "ETL/ELT pipelines for multi-source field data aggregation",
      "Governance-aligned modelling for donor accountability",
      "Cloud database platforms for low-connectivity environments",
      "Database security and access control for beneficiary data",
      "Metadata management for open development data standards",
      "Applied research data architecture for impact measurement"
    ]
  },

  assessment: "Design a multi-system data architecture for an applied research programme with governance documentation.",
  tools: "MongoDB, Cassandra, Redis, AWS RDS, Azure SQL, Collibra, dbt, Apache Airflow",
  ai: "AI-driven data architecture recommendations; intelligent data routing and pipeline automation."
} as const;
    ...
    <div className="max-w-7xl mx-auto px-6 pt-10">
      ...
      <div className="grid md:grid-cols-2 gap-8 p-8 border-b border-[var(--orange)]">
        <div>
          ...
          <p className="text-[var(--blue)]">Data architecture strategy, distributed systems, polyglot persistence, and governance-aligned modelling.</p>
        </div>
        <div>
          <h4 className="font-semibold mb-2 text-[var(--blue)]">Research Strand</h4>
          <p className="text-[var(--blue)]">Architecting data environments for applied research at scale with ethical data use controls.</p>
        </div>
      </div>
      ...
      <div className="p-8 bg-[var(--blue)] border border-[var(--orange)]">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="border border-[var(--orange)] rounded-lg px-4 py-3">
            ...
            <p className="text-[var(--white)] mt-2 text-sm sm:text-md md:text-md lg:text-sm">Cloud-native database architecture for enterprise analytics and business intelligence platforms.</p>
          </div>
          <div className="border border-[var(--white)] rounded-lg px-4 py-3">
            <h1 className="text-[var(--orange)] font-bold text-md sm:text-lg md:text-xl lg:text-xl">C — Livelihoods</h1>
            <p className="text-[var(--white)] mt-2 text-sm sm:text-md md:text-md lg:text-sm">Federated data systems for multi-partner development programmes and impact tracking.</p>
          </div>
        </div>
        </div>
    ...
    Livelihood
...
</div>
            {
                isOpen === "policy" && (
                    ...
                    <div className="">
                        <Image src="/images/vectorelements-IpkpFXQpqCI-unsplash.jpg" alt="Database Icon" width={500} height={220} className="mt-6 rounded-lg border border-gray-200 shadow-sm" />
                    </div>
                    </div>
                )
            }

            {
                isOpen === "business" && (
                    ...
                    <div className="">
                        <Image src="/images/vectorelements-ry8NwqCCH-8-unsplash.jpg" alt="Database Icon" width={500} height={220} className="mt-6 rounded-lg border border-gray-200 shadow-sm" />
                    </div>
                    </div>
                )
            }

            {
                isOpen === "livelihood" && (
                    ...
                    <div className="">
                        <Image src="/images/art-attack-QYib3N4NE7k-unsplash.jpg" alt="Database Icon" width={500} height={220} className="mt-6 rounded-lg border border-gray-200 shadow-sm" />
                    </div>
                    </div>
                )
            }
