...
import { FaArrowDown, FaBars, FaChevronDown, FaRegistered, FaSignOutAlt, FaTimes } from 'react-icons/fa'
...
const Navbar = () => {
    ...
    return (
        <div className="">
            <div className=' hidden lg:flex absolute top-25 flex justify-between items-center z-[60] w-full px-8'>
            {/* Logo */}
            <div>
                <Image
        ...
        <div className="lg:hidden">
            ...
            {isOpen && (
                <div className="flex flex-col gap-6 items-left text-black w-full  bg-white py-8 rounded-lg shadow-lg absolute top-full left-0 w-full mt-2 z-50">
                    <ul>
                        <li>
                        <Link href="/" className='hover:text-[var(--orange)] hover:bg-[var(--orange)]/20 w-full transition-colors '>
                            Home
                        </Link>
                    </li>
                    <li>
                    ...
                    >
                        <Link 
                            href="/" 
                            className='flex items-center text-left gap-1 hover:text-[var(--orange)] transition-colors  py-2 rounded-lg'
                        >
                            Courses
                            <FaChevronDown size={14} />
                        </Link>
                    ...
                    >
                        <Link 
                            href="/" 
                            className='flex items-center gap-1 hover:text-[var(--orange)] transition-colors  py-2 rounded-lg'
                        >
                            Features
                            <FaChevronDown size={14} />
                        </Link>
