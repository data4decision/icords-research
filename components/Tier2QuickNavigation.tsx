...
const QuickNavigation = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto px-6 pt-10'>
      ...
      {/* LS-02 */}
      <Link
        href="/courses/tier-2/LS-02"
        className={`px-6 py-3 rounded-full text-sm font-medium transition-all ${
          isActive('/courses/tier-2/LS-02')
            ? 'bg-[var(--blue)] text-white shadow-lg shadow-blue-500/30'
            : 'bg-white border border-gray-200 text-[var(--blue)] hover:bg-gray-100'
        }`}
      >
      ...
      {/* LS-03 */}
      <Link
        href="/courses/tier-2/LS-03"
        className={`px-6 py-3 rounded-full text-sm font-medium transition-all ${
          isActive('/courses/tier-2/LS-03')
            ? 'bg-[var(--blue)] text-white shadow-lg shadow-blue-500/30'
            : 'bg-white border border-gray-200 text-[var(--blue)] hover:bg-gray-100'
        }`}
      >
      ...
      <Link
        href="/courses/tier-2/LS-04"
        className={`px-6 py-3 rounded-full text-sm font-medium transition-all ${
          isActive('/courses/tier-2/LS-04')
            ? 'bg-[var(--blue)] text-white shadow-lg shadow-blue-500/30'
            : 'bg-white border border-gray-200 text-[var(--blue)] hover:bg-gray-100'
        }`}
      >
