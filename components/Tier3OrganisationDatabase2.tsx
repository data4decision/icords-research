...
const Tier3OrganisationDatabase2 = () => {
  ...
  topics: {
    policy: [
      "Prescriptive analytics for public resource allocation optimisation",
      "Reinforcement learning for adaptive policy delivery",
      "Operations research for government programme prioritisation",
      "Simulation modelling for national policy scenario analysis",
      "Causal inference for rigorous policy impact evaluation",
      "Multi-criteria decision analysis for government planning",
      "Publishing policy research — peer review, Zenodo, and ORCID",
      "AI decision systems for public sector advisory",
      "Research leadership and dissemination in policy contexts",
      "Driving governance transformation through prescriptive analytics"
    ],
    business: [
      "Prescriptive analytics for commercial optimisation and pricing",
      "Reinforcement learning for dynamic business decision systems",
      "Operations research for supply chain and logistics optimisation",
      "Simulation modelling for market entry and expansion scenarios",
      "Causal inference for rigorous commercial impact evaluation",
      "Multi-criteria decision analysis for corporate strategy",
      "Publishing business research — peer review and industry journals",
      "AI decision systems design for enterprise deployment",
      "Research leadership and thought leadership in business",
      "Driving market transformation through prescriptive analytics"
    ],
    livelihoods: [
      "Prescriptive analytics for livelihood intervention targeting",
      "Reinforcement learning for adaptive humanitarian response",
      "Operations research for development resource allocation",
      "Simulation modelling for food security and shock scenarios",
      "Causal inference for rigorous development impact evaluation",
      "Multi-criteria decision analysis for livelihoods programmes",
      "Publishing development research — peer review, Zenodo, and ORCID",
      "AI early-warning decision systems for livelihoods contexts",
      "Research leadership and knowledge dissemination in development",
      "Driving systemic change through prescriptive livelihoods analytics"
    ]
  },
  assessment: "Produce a D.RL-level prescriptive analytics research contribution advancing evidence-based practice",
  tools: "Python/R (full pipeline), Plotly Dash, Streamlit, Quarto, GitHub, Zenodo, ORCID, OR-Tools",
  ai: "Advanced AI decision systems; reinforcement learning for optimisation; AI ethics in prescriptive models"
} as const;
    ...
    <div className="max-w-7xl mx-auto px-6 pt-10">
      ...
      <div className="grid md:grid-cols-2 gap-8 p-8 border-b border-[var(--orange)]">
        <div>
          ...
          <p className="text-[var(--blue)]">★ PRESCRIPTIVE ANALYTICS MASTERY - Optimisation, thought leadership, and sector transformation</p>
        </div>
        <div>
          <h4 className="font-semibold mb-2 text-[var(--blue)]">Research Strand</h4>
          <p className="text-[var(--blue)]">Generating and publishing original analytical knowledge that shapes sector understanding</p>
        </div>
      </div>
      ...
      <div className="p-8 bg-[var(--blue)] border border-[var(--orange)]">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="border border-[var(--white)] rounded-lg px-4 py-3">
            ...
            <p className="text-[var(--white)] mt-2 text-sm sm:text-md md:text-md lg:text-sm">Prescriptive policy recommendations: resource allocation optimisation, intervention prioritisation</p>
          </div>
          <div className="border border-[var(--orange)] rounded-lg px-4 py-3">
            ...
            <p className="text-[var(--white)] mt-2 text-sm sm:text-md md:text-md lg:text-sm">Prescriptive business strategy: supply chain optimisation, pricing strategy, market expansion modelling</p>
          </div>
          <div className="border border-[var(--white)] rounded-lg px-4 py-3">
            <h1 className="text-[var(--orange)] font-bold text-md sm:text-lg md:text-xl lg:text-xl">C — Livelihoods</h1>
            <p className="text-[var(--white)] mt-2 text-sm sm:text-md md:text-md lg:text-sm">Optimising livelihood-intervention targeting; designing AI-assisted early-warning and response systems</p>
          </div>
        </div>
        </div>
...
export default Tier3OrganisationDatabase2